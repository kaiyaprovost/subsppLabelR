...
```
These rasters look good considering we are missing a lot of data from the center of the distribution. 
Now lets locate the unknown points relative to those rasters and do some clean up. 
...
Note that when you run this script, it will not generate any images.
