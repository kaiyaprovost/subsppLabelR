...
```
Hm. The *lepida* looks like it is a little gappy. Let's increase our density cutoff from 5% to 10% (the 90th percentile). 
...
Now we can see where the bulk of the data are found for these ranges. Most of the unknown samples we downloaded appear to be in subspecies *lepida*. Comparing the top 5% and top 10% shows us how choosing cutoffs can impact our downstream analyses. We will continue for now with the top 10%, as it seems to connect the bulk of the *lepida* samples.  
