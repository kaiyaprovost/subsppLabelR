...
nitens$loc_good
nitens$pol
write.table(nitens$loc_suspect,"~/Phainopela_nitens_nitens_lepida_subspplabelR_loc_suspect.txt",sep="\t",row.names = F)
write.table(nitens$loc_good,"~/Phainopela_nitens_nitens_lepida_subspplabelR_loc_good.txt",sep="\t",row.names = F)
