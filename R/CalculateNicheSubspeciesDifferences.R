...
localitiesToNicheMath = function(Env,loc,species,rep1=10,rep2=1000,
  ...
  if(do_files_exist==F) {
    ...
    lapply(1:length(bgenv_by_subspecies), FUN=function(i) {
      ...
      write.table(df,bgenv_sub_filename)
    })
    ...
    lapply(1:length(bgext_by_subspecies), FUN=function(i) {
      ...
      write.table(df,bgext_sub_filename)
    })
    ...
    lapply(1:length(bgpoints_by_subspecies), FUN=function(i) {
      ...
      write.table(df,bgpoints_sub_filename)
    })
    ...
    lapply(1:length(bgextbg_by_subspecies), FUN=function(i) {
      ...
      write.table(df,bgextbg_sub_filename)
    })
    ...
    bgenv_by_subspecies = lapply(bgenv_files,FUN=function(i){ df = read.table(i) })
    names(bgenv_by_subspecies) = bgenv_files_names

    bgext_by_subspecies = lapply(bgext_files,FUN=function(i){ df = read.table(i) })
    names(bgext_by_subspecies) = bgext_files_names

    bgpoints_by_subspecies = lapply(bgpoints_files,FUN=function(i){ df = read.table(i) })
    names(bgpoints_by_subspecies) = bgpoints_files_names

    bgextbg_by_subspecies = lapply(bgextbg_files,FUN=function(i){ df = read.table(i) })
